...
public class Stage3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stage3); // activity_stage3 레이아웃 설정
        ...
        mainMenuButton.setOnClickListener(v -> {
            Intent intent = new Intent(Stage3Activity.this, QuizMain.class); // 메인 화면으로 이동
    ...
    private void timeOut() {
        ...
        new Handler().postDelayed(() -> {
            Intent intent = new Intent(Stage3Activity.this, QuizMain.class); // 메인 화면 Intent 생성
            startActivity(intent); // 화면 전환
            finish(); // 현재 액티비티 종료
        }, 2000); // 2초 대기 후 실행
    }
